...
const createProduct = async (productCreationData: ProductCreationData): Promise<Result<null, ProductDTO>> => {
  try {
    ...
    return unexpectedError('Unknown error in ProductRepository.createProduct:', error)
  }
}
...
const deleteProduct = async (productId: string): Promise<Result> => {
  try {
    ...
    return unexpectedError('Unknown error in ProductRepository.deleteProduct:', error)
  }
}
...
const findProducts = async (): Promise<Result<null, ProductDTO[]>> => {
  try {
    ...
    return unexpectedError('Unknown error in ProductRepository.findProducts:', error)
  }
}
...
const updateProduct = async (productId: string, productData: ProductUpdateData): Promise<Result<null, ProductDTO>> => {
  try {
    ...
    return unexpectedError('Unknown error in ProductRepository.updateProduct:', error)
  }
}
