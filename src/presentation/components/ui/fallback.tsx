...
export const FallbackWrapper: React.FC<React.ComponentProps<'section'>> = ({
  ...
  <section
    className={classNames('fallback-wrapper', className)}
    {...errorWrapperRestProps}
  />
)
...
export const FallbackTitle: React.FC<React.ComponentProps<'h1'>> = ({
  ...
  <h1
    className={classNames('fallback-title', className)}
    {...errorTitleRestProps}
  />
)
...
export const FallbackDescription: React.FC<React.ComponentProps<'p'>> = ({
  ...
  <p
    className={classNames('fallback-description', className)}
    {...errorDescriptionRestProps}
  />
)
...
export const FallbackActions: React.FC<React.ComponentProps<'div'>> = ({
  ...
  <div
    className={classNames('fallback-actions', className)}
    {...errorActionsRestProps}
  />
)
...
export const Fallback: React.FC<FallbackProps> = ({ reset }) => (
  <FallbackWrapper>
    ...
    <FallbackDescription>
      {t('components.fallback.description')}
    </FallbackDescription>
